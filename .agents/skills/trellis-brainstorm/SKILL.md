...
```bash
TASK_DIR=$(C:\Users\limin\AppData\Roaming\uv\python\cpython-3.12-windows-x86_64-none\python.exe ./.trellis/scripts/task.py create "<short task title>" --slug <slug>)
```
