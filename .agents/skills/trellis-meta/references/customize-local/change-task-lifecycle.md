...
hooks:
  after_create:
    - "C:\Users\limin\AppData\Roaming\uv\python\cpython-3.12-windows-x86_64-none\python.exe .trellis/scripts/hooks/my_sync.py create"
  after_start:
    - "C:\Users\limin\AppData\Roaming\uv\python\cpython-3.12-windows-x86_64-none\python.exe .trellis/scripts/hooks/my_sync.py start"
  after_finish:
    - "C:\Users\limin\AppData\Roaming\uv\python\cpython-3.12-windows-x86_64-none\python.exe .trellis/scripts/hooks/my_sync.py finish"
  after_archive:
    - "C:\Users\limin\AppData\Roaming\uv\python\cpython-3.12-windows-x86_64-none\python.exe .trellis/scripts/hooks/my_sync.py archive"
```
...
1. Confirm the current task with `C:\Users\limin\AppData\Roaming\uv\python\cpython-3.12-windows-x86_64-none\python.exe ./.trellis/scripts/task.py current --source`.
