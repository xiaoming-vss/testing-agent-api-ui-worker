...
```bash
C:\Users\limin\AppData\Roaming\uv\python\cpython-3.12-windows-x86_64-none\python.exe ./.trellis/scripts/get_context.py --mode record
```
...
```bash
C:\Users\limin\AppData\Roaming\uv\python\cpython-3.12-windows-x86_64-none\python.exe ./.trellis/scripts/task.py archive <task-name>
```
...
```bash
C:\Users\limin\AppData\Roaming\uv\python\cpython-3.12-windows-x86_64-none\python.exe ./.trellis/scripts/add_session.py \
  --title "Session Title" \
  --commit "hash1,hash2" \
