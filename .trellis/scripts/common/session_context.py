...
def get_context_text(repo_root: Path | None = None) -> str:
    ...
    if not developer:
        lines.append(
            f"ERROR: Not initialized. Run: C:\Users\limin\AppData\Roaming\uv\python\cpython-3.12-windows-x86_64-none\python.exe ./{DIR_WORKFLOW}/{DIR_SCRIPTS}/init_developer.py <name>"
        )
        return "\n".join(lines)
