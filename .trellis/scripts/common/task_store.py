...
_SEED_EXAMPLE = (
    ...
    "Run `C:\Users\limin\AppData\Roaming\uv\python\cpython-3.12-windows-x86_64-none\python.exe .trellis/scripts/get_context.py --mode packages` to list available specs. "
...
def cmd_set_branch(args: argparse.Namespace) -> int:
    ...
    if not branch:
        ...
        print("Usage: C:\Users\limin\AppData\Roaming\uv\python\cpython-3.12-windows-x86_64-none\python.exe task.py set-branch <task-dir> <branch-name>")
        return 1
...
def cmd_set_base_branch(args: argparse.Namespace) -> int:
    ...
    if not base_branch:
        print(colored("Error: Missing arguments", Colors.RED))
        print("Usage: C:\Users\limin\AppData\Roaming\uv\python\cpython-3.12-windows-x86_64-none\python.exe task.py set-base-branch <task-dir> <base-branch>")
        print("Example: C:\Users\limin\AppData\Roaming\uv\python\cpython-3.12-windows-x86_64-none\python.exe task.py set-base-branch <dir> develop")
        print()
...
def cmd_set_scope(args: argparse.Namespace) -> int:
    ...
    if not scope:
        print(colored("Error: Missing arguments", Colors.RED))
        print("Usage: C:\Users\limin\AppData\Roaming\uv\python\cpython-3.12-windows-x86_64-none\python.exe task.py set-scope <task-dir> <scope>")
        return 1
