...
def ensure_developer(repo_root: Path | None = None) -> None:
    ...
    if not check_developer(repo_root):
        ...
        print(f"Run: C:\Users\limin\AppData\Roaming\uv\python\cpython-3.12-windows-x86_64-none\python.exe ./{DIR_WORKFLOW}/scripts/init_developer.py <your-name>", file=sys.stderr)
        sys.exit(1)
